...
O sistema permite realizar operações básicas de CRUD (Create, Read, Update e Delete) sobre os livros cadastrados, utilizando IDs para identificação e gerenciamento dos registros.
...
Arrays para armazenamento dos livros e IDs
